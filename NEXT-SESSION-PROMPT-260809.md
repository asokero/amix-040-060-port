...
Taustaksi `060-CAMPAIGN-PLAN-260805.md` ja
...
* **68040-rautasessio** — `NEXT-040-SESSION-RUNLIST.md`, vaatii A3640-kortinvaihdon.
...
Lue `NEXT-SESSION-PROMPT-260808.md`:n vastaava osio kokonaan; se pätee yhä. Lisäksi 8.8. opitut:
...
Samat kuin `NEXT-SESSION-PROMPT-260808.md`:ssä. Erityisesti:
