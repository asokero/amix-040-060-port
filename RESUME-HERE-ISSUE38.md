...
**Track 1 — Codex.** The brief is written, on the NAS, and committed: `ISSUE38-EXEC-ABORT-TASK.md`
...
* **Power-cut disk truth** — `REALHW-COPYBACK-POWERCUT-260729.md`, written and ready, kernel `-07`.
