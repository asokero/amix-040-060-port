...
Minimikorjaus on **neljä sitea atomisesti** (`src/patch_nfs_getpage.py`, 9 kanaria):
...
Molemmat dbg-kernelit kantavat `src/pvn_probe.s`:ää. Se kääriin `pvn_getpages`in
