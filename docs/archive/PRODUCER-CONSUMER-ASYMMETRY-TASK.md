...
Extracting every byte-patched address from `src/patch_*.py` and mapping it to its
...
grep -hoE '\(0x[0-9a-f]{4,6}\s*,\s*b"' src/patch_*.py
```
...
|---|---|---|
| `ufs_bmap` | `0x79d48`; 2 KiB at `0x79d74`, `0x79d7e`, `0x79d96`, `0x79da4`, `0x79daa`, `0x79ec0`, `0x79ee2`, `0x7a030` | excluded by the ISSUE-27 spec; **now consumes a 4 KiB-derived `alloc_only`** — see `docs/archive/PAGECREATE-REPRO-UFSBMAP-TASK.md` |
