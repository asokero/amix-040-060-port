...
ISSUE-41 (`src/segvn_prot040.s`) is present and working. Only the crossing case escapes.
...
* **No hardware work.** The Amiga runs `68060-260806-06`, accepted 2026-08-07 across the full run
  list including a power cut (`docs/REALHW-260806-06-ACCEPTANCE.md`). Do not propose anything that
