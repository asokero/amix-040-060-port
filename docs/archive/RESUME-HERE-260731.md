...
Read this file and nothing else to start. `docs/archive/RESUME-HERE-ISSUE38.md` and `docs/archive/RESUME-HERE-ISSUE22.md` are
...
only — never the subject of a verdict. Full record: `docs/REALHW-ACCEPTANCE-260731.md`.
...
* **Z3660 driver kernel** for a friend's 040-emulation bench: `unix-040-z3660-260731-26` boots with
  ...
  compiled object. Record: `docs/Z3660-KERNEL-FEASIBILITY-260731.md`.
