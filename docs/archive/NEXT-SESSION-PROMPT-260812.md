...
Kohta 1 on tehty (`9245d81`). Jäljellä auditin luvusta "D. Contract-derived CPU-specific state
implementation":
...
* Puu puhdas, kaikki committoitu. Viimeisin: `1514044`.
...
* `src/*.s` käännetään **`m68k-cbm-sysv4-gcc`**illa → **immediate on `&`, ei `#`**
...
* **Zorro III:** mitattu 10.8., palkinto on aito — Z2-aukko **3,09 MB/s vs paikallinen 28,66
  ...
  `docs/Z3-BUSBENCH-Z2-MEASUREMENT-260810.md`. Järjestys: VA2000-ajurin osoitekorjaus
