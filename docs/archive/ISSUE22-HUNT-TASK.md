...
```text
kernel repo HEAD                 5f79c96 (this brief adds documentation only)
...
ISSUE-22 exit probe over `c8d2cc0`, which your XPAGE audit was pinned against.
...
* **ISSUE-37 is closed**: the 68040 reports a misaligned access's START address while the missing
  page is the next one. Your audit's six-item unit is landed (`c8d2cc0`), MA-based with the proven
