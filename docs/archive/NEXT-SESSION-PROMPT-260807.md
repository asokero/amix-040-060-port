...
sama image lukee `68040-260806-06`, eikä se ole eri image. Mekanismi (`src/inituname040.s:32`):
...
1. `src/segvn_prot040.s` — SVR4:n per-sivu-suojaustarkistus takaisin `segvn_faultpage`iin.
...
on kokonaan katettu. Kirjaa `docs/REALHW-260806-06-ACCEPTANCE.md` ja päivitä muisti.
