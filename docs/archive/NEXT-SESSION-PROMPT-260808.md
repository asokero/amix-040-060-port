...
| vaihe | tila |
|---|---|
| M0 vektoriprobe | ✅ `src/kvecprobe040.s`, mittasi `kvp_vec[11]` 0→4 |
...
* **68040-rautasessio** — `docs/archive/NEXT-040-SESSION-RUNLIST.md`, vaatii A3640-kortinvaihdon. Niputettu
