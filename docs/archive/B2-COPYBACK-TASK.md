...
**Määritelty 2026-07-23, heti B1-WT-rautahyväksynnän jälkeen (commit 5f745d5 +
docs 0e3832f, tagit `pre-dc-enable`/`b1-dc-enable`). B1 on HYVÄKSYTTY oikealla
...
- Kernelrepo commit: `5f745d5` (B1-DC-ENABLE; docs-tila `0e3832f`)
