...
>
> Boot with `unix_boot040` (rel.c PC-rel reloc fix f0ed373 (pre-split amix-040-060-port hash; published as amix-unix-boot v1.0-040-060)) — mandatory for any kernel
