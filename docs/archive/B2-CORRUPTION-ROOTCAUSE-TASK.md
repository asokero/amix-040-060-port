...
- Kernelrepo commit: `7dcef75` (B2-CB-HOOKS 381829b + docs)
...
- Toteutuslähteet: `src/dma_cache040.s`, `src/cb_release040.s`,
  `src/patch_a3091_dma.py`, `src/patch_cb_release.py`.
