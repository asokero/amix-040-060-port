...
(`ad9eb60`). A pre-flight grep also confirmed that no override in this project hardcodes the load
...
`archive/NEXT-040-SESSION-RUNLIST.md` recorded the open risk plainly: *"there is no real-68040 datapoint …
...
`archive/NEXT-EVENING-RUNLIST-260813.md` predicted that **ISSUE-39** (`hat_sdtalloc` out of contiguous
