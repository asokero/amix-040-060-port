...
`archive/NEXT-SESSION-PROMPT-260807.md` was executed, including the power-cut disk truth, which had
never been run for this line.

## What is in `-06` over `-02`

1. `src/segvn_prot040.s` — SVR4's per-page permission check restored to
