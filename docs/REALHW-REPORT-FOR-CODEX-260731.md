...
2026-07-31. This answers `archive/ISSUE38-EXEC-ABORT-TASK.md` and your reply
...
records    ISSUE38-ICODE-CACHE-FINDING-260730.md, REALHW-COPYBACK-ACCEPTANCE-260730.md,
           REALHW-COPYBACK-POWERCUT-260730.md; commits f1bf9d0, 5925163, 96b8177, 7d02bc3, f093bd8
```
...
* **"`as_fault`'s wrapper changes cache footprint and timing."** The masker is not footprint or
  timing: `src/assegat_dbg.s`'s **`copyout` wrapper executes an unconditional `cpusha bc`**
...
`src/cb_icode040.s`, in the **base** link, guarded by a relink check that refuses an image
