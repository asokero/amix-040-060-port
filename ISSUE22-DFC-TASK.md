...
This supersedes the four questions in `ISSUE22-HUNT-TASK.md`. Your answer there
...
`prototypes/wb040.s`'s `Lwb_do` sets `DFC = WBxS & 7` to re-issue a pending write-back with the
