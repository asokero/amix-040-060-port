...
## DONE (working, in src/hat040.s + kvm040.s + patch_modelb.py)
...
`src/hat040.s` holds the 040 hat_pteload.  Verified: assembles clean
...
### segkmem_mapin — DONE (src/kvm040.s, verified, committed)
