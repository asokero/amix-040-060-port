...
P = [
 ...
 #
 # WHY as_faulta + as_setprot are OMITTED (the 2026-06-25 4b4786c both-4KB failure post-mortem):
 #   4b4786c converted as_fault+segvn_fault (CORRECT bytes) BUT ALSO as_faulta + as_setprot, and
 ...
 # This is what bus-errored kmem_alloc in the both-4KB attempt (4b4786c): NOT as_setprot, but the
