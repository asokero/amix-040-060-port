...
`prototypes/isp61_060.s` emulates exactly one instruction form on the 68060:
...
```text
prototypes/isp61_060.s          the handler
prototypes/patch_isp_vec61.py   M68Kvec[61] -> isp61_vec, after the FPSP block
