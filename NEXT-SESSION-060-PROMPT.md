...
Taustaksi 68060-prestudy.md (§3 ja §7 = mitä 060-tuki jo sisältää) ja Codexin kaksi analyysia
amix-kernel-analysis/vm-map/M68060-XPAGE-ACCEPTANCE.md ja M68060-SUPPORT-LANDSCAPE.md. 040-portin
tila on RESUME-HERE-260801.md; se on suljettu eikä sitä avata tässä sessiossa.
...
Ajolista järjestyksessä:
 ...
 4. mkall.sh, sitten batteryrun2.sh ja burstrepeat2.sh. Vertailuluvut 040:ltä ovat
    REALHW-ISSUE40-ACCEPTANCE-260802.md:ssä: patteristo 10/10, burst 96/96, hat_pfnmiss_n
