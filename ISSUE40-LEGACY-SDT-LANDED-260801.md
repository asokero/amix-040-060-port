...
| unit | file | mechanism |
|---|---|---|
| `hat_legacy_sdt_free` | `prototypes/legacysdt040.s` | `hat_growsdt(as+0x14, 2, 0)` then `(…, 3, 0)` |
| call site | `prototypes/hat040.s` @ `Lhf_nodbg` | after the null-root guard, **before** the A/B/C walk |
...
Restating the five criteria from `NEXT-SESSION-ISSUE40-PROMPT.md` honestly.
...
Next: `ISSUE40-PTDAT-CODEX-QUESTIONS.md`.
