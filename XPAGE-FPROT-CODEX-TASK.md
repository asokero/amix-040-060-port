...
`wb060_xpage` (`kernelsupport/prototypes/wb040.s`) does that. When the far page is present but
...
kernelsupport/prototypes/wb040.s              wb060_xpage, Lwx_callp, Lwx_prot (commit 0b359ab)
