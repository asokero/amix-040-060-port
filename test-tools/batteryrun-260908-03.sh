# batteryrun-260908-03.sh -- GENERATED, do not edit by hand.
#   sh tools/gen-battery.sh build/unix-040-quiet-rtg 0x08000000 > test-tools/batteryrun-260908-03.sh
#
#   artifact   build/unix-040-quiet-rtg
#   build id   68040-260908-03
#   sha256     8a14754c5c8a83b4b05b7cc0f43992f25323bc74601aa82136330406b447c33e
...
#
#   (nohup sh -c "sh /tmp/batteryrun-260908-03.sh /tmp/battery.log > /tmp/battery.log 2>&1" &)
K=/kpeek
