...
m68k-cbm-sysv4-ld -r -o "$OUT" "$HERE/build/unix-040-dbg-stage1" \
	...
	"$HERE/build/sigkill_dbg.o" "$HERE/build/ktrap_latch.o"

echo "[*] overridden defs (single strong def each):"
for s in ddopen hat_dup k_trap; do
