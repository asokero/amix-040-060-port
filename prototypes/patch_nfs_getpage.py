...
#   python3 prototypes/patch_nfs_getpage.py [kernel]              apply   (default build/unix-040)
#   python3 prototypes/patch_nfs_getpage.py --revert <kernel>     un-apply, atomically
#
...
# Re-stamp the reverted copy (prototypes/stamp_buildid.py) so `uname -m` distinguishes them --
