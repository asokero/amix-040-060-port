...
## Wiring
- extend `prototypes/hatalloc_dbg.s` (already has the page_abort wrapper + msg pool +
  frame-walk helper), OR a new `prototypes/freeprobe_dbg.s` in the dbg overlay only.
