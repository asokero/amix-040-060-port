...
`-01` carried the ISSUE-43 unit (`prototypes/fpu060.s`, `8f4e43a`). On its first boot:
...
`c13d3b8` (2026-08-11) removed the null-frame guard from `Lco_fparith` — correctly — but the
...
Fixed in `7cbbc67`, one instruction.
